...
export const pageSeoTable = pgTable(
  "page_seo",
  {
    ...
    slugEn: text("slug_en").notNull().default(""),
    slugJa: text("slug_ja").notNull().default(""),
    slugZhCn: text("slug_zh_cn").notNull().default(""),
